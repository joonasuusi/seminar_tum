...
%\avainsanat{orientaatiokurssi, HOPS, omakohtainen reflektio, itky4000}%

\keywords{literature review, % <-- Pro tip: LaTeX ei näe rivinvaihtoa, kun on %
          security, %
          privacy% ... joten LaTeXille koko pätkä on yksi rivi
} % <--- Loppusulku!
...
% Laitetaan oppimispäiväkirjaan harjoituksen vuoksi myös johdanto ja
% yhteenveto. Johdannoksi voit jättää alkuperäisen mallitekstin, jonka
% yritin tehdä mahdollisimman geneeriseksi.

% Voit myös kirjoittaa johdannon halutessasi uudelleen omalla
% tyylilläsi. Johdanto on aina lyhyt kuvaus siitä, mitä kirjoitelmassa
% on ja erityisesti lähteisiin pohjautuva perustelu sille, miksi se on
% tärkeää. Nyt en kuitenkaan laita tähän mallitekstiin lähteitä, koska
% tieteellinen hygienia vaatisi, että olisit varmuudella itsekin
% lukenut lähteen, joka tässä mainittaisiin. Nyt en pakota tässä
% lukemaan mitään, joten laitan mahdolliset omat viitteeni myöhempiin
% lukuihin, jotka korvaat omalla tekstilläsi. Voit viitata haluamiisi
% lähteisiin, jotka olet itse lukenut. Johdannon viimeisessä
% tekstikappaleessa kerrotaan lukijalle, mitä kussakin myöhemmistä
% pääluvuista käsitellään.


% Gradussa tähän kohtaan tulisi tutkimuskysymys ja lähteisiin
% perustuva perustelu sille, miksi se on tärkeä ja ajankohtainen.
% Eikä oikeastaan muuta. Jätetään se oppimispäiväkirjan mielessä
% lyhyimmäksi mahdolliseksi :).
