...
%
In the results [\ref{results}] section, findings are analysed from the survey and observed how students use VCA's and how they react when facing some kind of security issues. And most importantly, are they aware of the data collecting which happens while using these kind of applications.
