...
\title{Security and privacy issues with conference applications and browsers}
%\translatedtitle{}%
...
We conducted a literature review [\ref{literatureReview}] and a questionnaire survey focusing on privacy and security issues with VCA's [\ref{vca}]. Survey was directed to university students.
%
...
%
In the end of the research, reader can find discussion about the results and suggestions towards the future [\ref{discussion}]. These suggestions are solely based on our point of views, which are found in the research process.
